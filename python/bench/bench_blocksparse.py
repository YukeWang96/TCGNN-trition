...
def bench_matmul(M, N, K, block, layout_mode, op_mode, AT, BT, dtype, provider, warmup=100, rep=100):
    # print("M: {}, N: {}, K: {}, block: {}, layout_mode: {}, op_mode: {}, AT: {}, BT: {}, dtype: {}, provider: {}, warmup: {}, rep: {}".format(M, N, K, block, layout_mode, op_mode, AT, BT, dtype, provider, warmup, rep))
    N = 16
    # print("M: {}, N: {}, K: {}, block: {}, layout_mode: {}, op_mode: {}, AT: {}, BT: {}, dtype: {}, provider: {}, warmup: {}, rep: {}".format(M, N, K, block, layout_mode, op_mode, AT, BT, dtype, provider, warmup, rep))
    Z, H = 1, 1
    make_layout = {
    ...
    if provider == 'triton':
        ...
        # print("Time (ms): ", min_ms)
        print(min_ms)
        # print("max_ms {}, mean_ms {}, min_ms {} ", max_ms, mean_ms, min_ms)
...
bench_matmul.run(print_data=False, show_plots=False)
